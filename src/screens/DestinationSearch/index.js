...
const DestinationSearchScreen = () => {
    ...
    const goa = { uri : "https://media.istockphoto.com/vectors/young-woman-sunbathing-on-a-beach-vector-id1137918812?k=20&m=1137918812&s=612x612&w=0&h=ldg-CVvTjl2kSGo2UZRYa-4wxH_AFbdDpu1UnNxA_Zs=" };
  return (    
        <Pressable onPress={(data, details = null) => {
            ...
            <View style={styles.container}>
                ...
                <View style={styles.cont}>
                    <Card style={styles.card}>
                        <CardImage source={goa} style = {styles.image}/>
                    </Card>
                    <Card style={styles.card}>
                        <CardImage source={goa} style = {styles.image}/>
                    </Card>
